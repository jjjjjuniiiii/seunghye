...
public class MarketingDAO extends MybatisConnector {
	private final String namespace = "marketing";
	SqlSession sqlSession;

	private static MarketingDAO instance = new MarketingDAO();
	public static MarketingDAO getInstance() {
		return instance;
	}
	
	//select
	public List selectMarketing1Info() {
		sqlSession = sqlSession();
		try {
			return sqlSession.selectList(namespace + ".selectMarketing1Info");
		} finally {
			sqlSession.close();
		}
	}	
	public List selectMarketing2Info() {
		sqlSession = sqlSession();
		try {
			return sqlSession.selectList(namespace + ".selectMarketing2Info");
		} finally {
			sqlSession.close();
		}
	}
	...
	//insert
	public void insertMarketing1(int sequence, String part, String approved_disuse, String large_category, 
		...
		try {
			sqlSession.insert(namespace + ".insertMarketing1", map);
			sqlSession.commit();
		} finally {
			sqlSession.close();
		}
	}	
	public void insertMarketing2(int sequence, String part, String approved_disuse, String large_category, 
			String small_category, String system, String using, String host_name, String manufacturer, 
			String model_name, String specification, int purchase_num, String install_name, int install_num, 
			Date start_date, String deterioration, int start_money, String place, String location,
			String status_progress, String contract_term, int month_money, String status_use, 
		...
		try {
			sqlSession.insert(namespace + ".insertMarketing2", map);
			sqlSession.commit();
		} finally {
			sqlSession.close();
		}
	...
	//update
	//(1) disuse
	public void updateDisuseMarketing1(int sequence) {
		sqlSession = sqlSession();
		try {
			sqlSession.update(namespace + ".updateDisuseMarketing1", sequence);
			sqlSession.commit();
		} finally {
			sqlSession.close();
		}
	}	
	public void updateDisuseMarketing2(int sequence) {
		sqlSession = sqlSession();
		try {
			sqlSession.update(namespace + ".updateDisuseMarketing2", sequence);
			sqlSession.commit();
		} finally {
			sqlSession.close();
		}
	...
	//(2) update
	public void updateMarketing1(int sequence, String large_category, String small_category, String system, String using, 
		...
		map.put("EOS_end_date", EOS_end_date);		
		try {
			sqlSession.update(namespace + ".updateMarketing1", map);
			sqlSession.commit();
		} finally {
			sqlSession.close();
		}
	}
	public void updateMarketing2(int sequence, String large_category, String small_category, String system, String using, 
			String host_name, String manufacturer, String model_name, String specification, int purchase_num, 
			String install_name, int install_num, Date start_date, String deterioration, int start_money, 
			String place, String location, String status_progress, String contract_term, int month_money, 
			String status_use, String disuse_or_recycling, String reason_disuse, String note, String unification, String EOS_end_date) {
		...
		map.put("EOS_end_date", EOS_end_date);		
		try {
			sqlSession.update(namespace + ".updateMarketing2", map);
			sqlSession.commit();
		} finally {
			sqlSession.close();
		}
	...
	//delete
	public void deleteMarketing1(int sequence) {
		sqlSession = sqlSession();
		try {
			sqlSession.delete(namespace + ".deleteMarketing1", sequence);
			sqlSession.commit();
		} finally {
			sqlSession.close();
		}
	}
	public void deleteMarketing2(int sequence) {
		sqlSession = sqlSession();
		try {
			sqlSession.delete(namespace + ".deleteMarketing2", sequence);
			sqlSession.commit();
		} finally {
			sqlSession.close();
		}
	...
	//count
	public int countMarketing() {//sequence
		sqlSession = sqlSession();
		try {
			return sqlSession.selectOne(namespace + ".countMarketing");
		} finally {
			sqlSession.close();
		}
	}

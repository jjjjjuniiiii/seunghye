...
public class SupportDAO extends MybatisConnector {
	private final String namespace = "support";
	...
	//select
	public List selectSupport1Info() {
		sqlSession = sqlSession();
		try {
			return sqlSession.selectList(namespace + ".selectSupport1Info");
		} finally {
			sqlSession.close();
		}
	}	
	public List selectSupport2Info() {
		sqlSession = sqlSession();
		try {
			return sqlSession.selectList(namespace + ".selectSupport2Info");
		} finally {
			sqlSession.close();
		}
	}
	...
	//insert
	public void insertSupport1(int sequence, String part, String approved_disuse, String large_category, 
		...
		try {
			sqlSession.insert(namespace + ".insertSupport1", map);
			sqlSession.commit();
		} finally {
			sqlSession.close();
		}
	}	
	public void insertSupport2(int sequence, String part, String approved_disuse, String large_category, 
			String small_category, String system, String using, String host_name, String manufacturer, 
			String model_name, String specification, int purchase_num, String install_name, int install_num, 
			Date start_date, String deterioration, int start_money, String place, String location,
			String status_progress, String contract_term, int month_money, String status_use, 
		...
		try {
			sqlSession.insert(namespace + ".insertSupport2", map);
			sqlSession.commit();
		} finally {
			sqlSession.close();
		}
	...
	//update
	//(1) disuse
	public void updateDisuseSupport1(int sequence) {
		sqlSession = sqlSession();
		try {
			sqlSession.update(namespace + ".updateDisuseSupport1", sequence);
			sqlSession.commit();
		} finally {
			sqlSession.close();
		}
	}	
	public void updateDisuseSupport2(int sequence) {
		sqlSession = sqlSession();
		try {
			sqlSession.update(namespace + ".updateDisuseSupport2", sequence);
			sqlSession.commit();
		} finally {
			sqlSession.close();
		}
	...
	//(2) update
	public void updateSupport1(int sequence, String large_category, String small_category, String system, String using, 
		...
		map.put("EOS_end_date", EOS_end_date);		
		try {
			sqlSession.update(namespace + ".updateSupport1", map);
			sqlSession.commit();
		} finally {
			sqlSession.close();
		}
	}
	public void updateSupport2(int sequence, String large_category, String small_category, String system, String using, 
			String host_name, String manufacturer, String model_name, String specification, int purchase_num, 
			String install_name, int install_num, Date start_date, String deterioration, int start_money, 
			String place, String location, String status_progress, String contract_term, int month_money, 
			String status_use, String disuse_or_recycling, String reason_disuse, String note, String unification, String EOS_end_date) {
		...
		map.put("EOS_end_date", EOS_end_date);		
		try {
			sqlSession.update(namespace + ".updateSupport2", map);
			sqlSession.commit();
		} finally {
			sqlSession.close();
		}
	...
	//delete
	public void deleteSupport1(int sequence) {
		sqlSession = sqlSession();
		try {
			sqlSession.delete(namespace + ".deleteSupport1", sequence);
			sqlSession.commit();
		} finally {
			sqlSession.close();
		}
	}
	public void deleteSupport2(int sequence) {
		sqlSession = sqlSession();
		try {
			sqlSession.delete(namespace + ".deleteSupport2", sequence);
			sqlSession.commit();
		} finally {
			sqlSession.close();
		}
	...
	//count
	public int countSupport() {//sequence
		sqlSession = sqlSession();
		try {
			return sqlSession.selectOne(namespace + ".countSupport");
		} finally {
			sqlSession.close();
		}
	}

...
public class GiftcardDAO extends MybatisConnector {
	private final String namespace = "giftcard";
	...
	//select
	public List selectGiftcard1Info() {
		sqlSession = sqlSession();
		try {
			return sqlSession.selectList(namespace + ".selectGiftcard1Info");
		} finally {
			sqlSession.close();
		}
	}	
	public List selectGiftcard2Info() {
		sqlSession = sqlSession();
		try {
			return sqlSession.selectList(namespace + ".selectGiftcard2Info");
		} finally {
			sqlSession.close();
		}
	}
	...
	//insert
	public void insertGiftcard1(int sequence, String part, String approved_disuse, String large_category, 
		...
		try {
			sqlSession.insert(namespace + ".insertGiftcard1", map);
			sqlSession.commit();
		} finally {
			sqlSession.close();
		}
	}	
	public void insertGiftcard2(int sequence, String part, String approved_disuse, String large_category, 
			String small_category, String system, String using, String host_name, String manufacturer, 
			String model_name, String specification, int purchase_num, String install_name, int install_num, 
			Date start_date, String deterioration, int start_money, String place, String location,
			String status_progress, String contract_term, int month_money, String status_use, 
		...
		try {
			sqlSession.insert(namespace + ".insertGiftcard2", map);
			sqlSession.commit();
		} finally {
			sqlSession.close();
		}
	...
	//update
	//(1) disuse
	public void updateDisuseGiftcard1(int sequence) {
		sqlSession = sqlSession();
		try {
			sqlSession.update(namespace + ".updateDisuseGiftcard1", sequence);
			sqlSession.commit();
		} finally {
			sqlSession.close();
		}
	}	
	public void updateDisuseGiftcard2(int sequence) {
		sqlSession = sqlSession();
		try {
			sqlSession.update(namespace + ".updateDisuseGiftcard2", sequence);
			sqlSession.commit();
		} finally {
			sqlSession.close();
		}
	...
	//(2) update
	public void updateGiftcard1(int sequence, String large_category, String small_category, String system, String using, 
		...
		map.put("EOS_end_date", EOS_end_date);		
		try {
			sqlSession.update(namespace + ".updateGiftcard1", map);
			sqlSession.commit();
		} finally {
			sqlSession.close();
		}
	}
	public void updateGiftcard2(int sequence, String large_category, String small_category, String system, String using, 
			String host_name, String manufacturer, String model_name, String specification, int purchase_num, 
			String install_name, int install_num, Date start_date, String deterioration, int start_money, 
			String place, String location, String status_progress, String contract_term, int month_money, 
			String status_use, String disuse_or_recycling, String reason_disuse, String note, String unification, String EOS_end_date) {
		...
		map.put("EOS_end_date", EOS_end_date);		
		try {
			sqlSession.update(namespace + ".updateGiftcard2", map);
			sqlSession.commit();
		} finally {
			sqlSession.close();
		}
	...
	//delete
	public void deleteGiftcard1(int sequence) {
		sqlSession = sqlSession();
		try {
			sqlSession.delete(namespace + ".deleteGiftcard1", sequence);
			sqlSession.commit();
		} finally {
			sqlSession.close();
		}
	}
	public void deleteGiftcard2(int sequence) {
		sqlSession = sqlSession();
		try {
			sqlSession.delete(namespace + ".deleteGiftcard2", sequence);
			sqlSession.commit();
		} finally {
			sqlSession.close();
		}
	...
	//count
	public int countGiftcard() {//sequence
		sqlSession = sqlSession();
		try {
			return sqlSession.selectOne(namespace + ".countGiftcard");
		} finally {
			sqlSession.close();
		}
	}
